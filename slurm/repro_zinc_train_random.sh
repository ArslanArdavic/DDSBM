...
#SBATCH --output=/project/project_465002822/DDSBM/slurm/log/repro_zinc_train_random_%j.out
#SBATCH --error=/project/project_465002822/DDSBM/slurm/log/repro_zinc_train_random_%j.err
#SBATCH --nodes=1
